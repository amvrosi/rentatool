...
export default function CustomerRentalShow({ rental }: Props) {
    ...
    function handleCancel() {
        if (confirm('Are you sure you want to cancel this rental?')) {
            router.post(`/my/rentals/${rental.id}/cancel`);
        }
    }
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-2">
                            <div className="flex justify-between text-sm">
                                ...
                                <span>${Number(rental.daily_rate_snapshot).toFixed(2)}</span>
                            </div>
                            <div className="flex justify-between text-sm">
                            ...
                            <div className="flex justify-between text-sm">
                                ...
                                <span>${Number(rental.deposit_amount).toFixed(2)}</span>
                            </div>
                            <hr />
